...
@export_range(0.01, 1.0, 0.01) var threshold: float = 1.0
...
@export_range(0.1, 10.0, 0.1) var damage_mult: float = 1.0
@export_range(0.1, 10.0, 0.1) var speed_mult: float = 1.0
...
@export_range(0.0, 60.0, 0.1) var ability_interval: float = 0.0
