...
- Tests: 908 python + the headless Godot suites (was 95) — all green. The two branches merged in
...
- GDScripts under `scripts/`: 208 (was 139 at the sweep; the subsystem rebuilds since have added
...
- Validated files: 161/161 (was 85, then 151, then 159: +4 authored midgame waves)
