...
- Tests: 815 python + the headless Godot suites (was 95) — all green. The two branches merged in
...
- GDScripts under `scripts/`: 197 (was 139 at the sweep; the subsystem rebuilds since have added
