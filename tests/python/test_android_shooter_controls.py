...
class AndroidShooterControlsTests(unittest.TestCase):
    ...
    def test_manual_aim_is_camera_relative_and_survives_strafing(self):
        ...
        self.assertLess(physics.index('_controller.tick(move, delta)'), physics.index('_controller.face_direction(fire_facing)'))
    ...
    def test_android_guidance_never_requires_keyboard(self):
        ...
        camera = body('scripts/main/camera/camera_input_handler.gd', 'handle_touch_drag')
        self.assertIn('_mouse_accum += relative', camera)
