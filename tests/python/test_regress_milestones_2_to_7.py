...
class Milestone6_AndroidPerf(unittest.TestCase):
    def test_mobile_renderer_and_perf(self):
        ...
        self.assertTrue(
            'version/name="0.7.0"' in txt2 or 'version/name="0.6.0"' in txt2 or 'version/name="0.5.0"' in txt2
        )
        self.assertIn('gradle_build/min_sdk="24"', txt2)
        self.assertIn('gradle_build/target_sdk="34"', txt2)
