"""Regression: player.tscn load_steps — 28 after the fallback Body capsule + material
(was 26 after ember_scepter/moonlance/venom_chain integration)."""
