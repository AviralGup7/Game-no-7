...
class TestMinimapRadarShape(unittest.TestCase):
    ...
    def test_threat_features_present(self) -> None:
        ...
        # 4.4 group probe: has_group() (3.x's has_node_in_group is gone).
        self.assertIn("has_group(BossController.BOSS_GROUP)", text)
        self.assertNotIn("has_node_in_group", text)
