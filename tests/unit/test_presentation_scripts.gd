...
const SCRIPTS := [
	...
	"res://scripts/arena/decorator_props.gd",
	"res://scripts/arena/arena_warehouse_yard.gd",
	"res://scripts/visuals/character_visuals.gd",
	"res://scripts/visuals/effect_director.gd",
	"res://scripts/visuals/effect_event_handlers.gd",
	"res://scripts/visuals/effect_skill_catalog.gd",
	"res://scripts/visuals/effect_templates.gd",
	"res://scripts/visuals/effect_placement.gd",
	"res://scripts/visuals/effect_readability.gd",
	"res://scripts/visuals/effect_priorities.gd",
