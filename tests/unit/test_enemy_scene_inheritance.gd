...
const GOLD := {
	&"basic": {
		...
		"anim": [1.7, "res://assets/scifi/robots/basic.glb", "Fire"],
	},
	&"fast": {
		"shape": ["CapsuleShape3D", 0.5, 1.6], "mesh": ["CapsuleMesh", 0.45, 1.4],
		"albedo": Color(0.85, 0.5, 0.2, 1), "nav": [1.5, 1.2, 0.6],
		"target": null, "attack": null,
		"anim": [1.65, "res://assets/scifi/robots/fast.glb", "Fire"],
	},
	&"heavy": {
		"shape": ["CapsuleShape3D", 0.5, 1.6], "mesh": ["CapsuleMesh", 0.45, 1.4],
		"albedo": Color(0.85, 0.5, 0.2, 1), "nav": [1.5, 1.2, 0.6],
		"target": null, "attack": null,
		"anim": [1.85, "res://assets/scifi/robots/heavy.glb", "Fire"],
	},
	&"dasher": {
		...
		"anim": [0.85, "res://assets/scifi/robots/dasher.glb", "Fire"],
	},
	&"exploder": {
		...
		"anim": [1.9, "res://assets/scifi/robots/exploder.glb", "Fire"],
		"emissive": true,
	},
	&"ranged": {
	...
	&"warlord": {
		...
		"anim": [2.6, "res://assets/scifi/robots/warlord.glb", "Fire"],
		"boss": true,
	},
}
